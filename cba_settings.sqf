...
// ACE Field Rations
force acex_field_rations_enabled = true;		// Enable the ACE hunger system
...
// VCOM AI East Skill
force Vcm_AISkills_East_AimingAccuracy = 0.27;
force Vcm_AISkills_East_aimingShake = 0.24;
force Vcm_AISkills_East_aimingSpeed = 0.24;
