class a3ph
{
	class Functions
	{
		class advancedSlingLoad
		{
			file = "scripts\functions\logi\fn_advancedSlingLoadingInit.sqf";
		};
		class advancedTowing
		{
			file = "scripts\functions\logi\fn_advancedTowingInit.sqf";
		};
		class kpfuel
		{
			file = "scripts\functions\logi\kp_fuel_consumption.sqf";
		};
		class civKilled
		{
			file = "scripts\functions\ai\civKilled.sqf";
		};
	};
};
...
class VCOM
{
	...
	class FSM
	{
		file = "scripts\functions\ai\Vcom\FSMS";
	...
	class Functions 
	{
		file = "scripts\functions\ai\Vcom\Functions\VCM_Functions";
